export const addressRegex = /^[#.0-9a-zA-Z\s,-]+$/i;
export const phoneRegex = /\(?\+[0-9]{1,3}\)? ?-?[0-9]{1,3} ?-?[0-9]{3,5} ?-?[0-9]{4}( ?-?[0-9]{3})? ?(\w{1,10}\s?\d{1,6})?$/i;
...
export const rfcRegex = /^[ña-z]{3,4}[0-9]{6}[0-9a-z]{3}$/i;